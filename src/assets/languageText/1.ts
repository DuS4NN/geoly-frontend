export const text = {
    ...
    groups: {
        ...
        createdGroups: 'Vytvorené skupiny',
        editGroup: 'Upraviť',
        ...
        noData: 'Zdá sa, že nemáte vytvorenú žiadnu skupinu.',
    ...
    settings: {
        ...
        password: 'Heslo',
        appearance: 'Vzhľad',
        deleteImage: 'Odstrániť profilový obrázok',
        deleteImageText: 'Ste si istý, že chcete natrvalo odstrániť Váš profilový obrázok?',
